    ...
    function GetDataGroupedByFields(data, flds) {
        ...
        return Object.keys(obj).map(function (key) {
            if (obj[key].Employees<10){
                var rtnObj = {Employees: obj[key].Employees}; 
            }
            else{
            var rtnObj = {Employees: Math.round(obj[key].Employees/10)*10}; //TEST ROUNDING
            }
            flds.forEach(function (fld) {
...
function makedashboard(){
    ...
    arcgisRest.queryFeatures({
        ...
        var fullfdidata = new kendo.data.DataSource({
            ...
            // pageSize: 10,
            // group:[{field:"UltimateParentCountry"}, {field:"UltimateParentName"}],
            // aggregates:[
